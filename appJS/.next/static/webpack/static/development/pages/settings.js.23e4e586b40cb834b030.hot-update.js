...
function settings() {
  ...
  onChangeStrangerDetection = function onChangeStrangerDetection() {
    setStrangerDetection(!StrangerDetection);
  };

  onChangeAuthorizedDetection = function onChangeAuthorizedDetection() {
    setAuthorizedDetection(!AuthorizedDetection);
  };

  onChangeSMS = function onChangeSMS() {
    setSMS(!SMS);
  };
...
//# sourceMappingURL=settings.js.23e4e586b40cb834b030.hot-update.js.map